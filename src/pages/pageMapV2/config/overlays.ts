...
const LAYER_OVERLAY_TEMP_CONFIG_GROUP: Record<string, TempOverlayOptions> = {
  ...
  'A:XM:DESERT': {
    ...
    children: [
      ...
      ['固定底图-秘仪1', [-6552, 2220, -6108, 2466], '秘仪'],
      ['固定底图-秘仪2', [-6553, 2122, -6256, 2454], '秘仪'],
      ['固定底图-秘仪3', [-6516, 2170, -6222, 2414], '秘仪'],
      ['固定底图-王陵1', [-6932, 2269, -6826, 2348], '王陵'],
      ['固定底图-王陵2', [-6972, 2181, -6612, 2427], '王陵'],
      ['固定底图-王陵3', [-6945, 2241, -6772, 2401], '王陵'],
      ['固定底图-舍身1', [-5414, 2029, -5060, 2460], '舍身'],
      ['固定底图-舍身2', [-5514, 2136, -5203, 2533], '舍身'],
      ['固定底图-舍身3', [-5390, 2189, -5067, 2520], '舍身'],
