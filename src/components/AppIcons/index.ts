...
export { default as IconArrowDottedNeSw } from './IconArrowDottedNeSw.vue'
...
export { default as IconInvitation } from './IconInvitation.vue'
export { default as IconLayers } from './IconLayers.vue'
export { default as IconLayersFilled } from './IconLayersFilled.vue'
...
export { default as IconUnknown } from './IconUnknown.vue'
