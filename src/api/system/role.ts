...
/** 将角色赋予给用户 将角色赋予给用户 PUT /role/user */
...
/** 将角色从用户剥夺 将角色从用户剥夺，同时将高于此角色的角色全部剥夺 DELETE /role/user */
...
/** 返回可用角色列表 返回可用角色列表 GET /role/list */
...
/** 批量删除角色 批量删除角色（未找到的角色通过错误抛出） DELETE /role/batch */
