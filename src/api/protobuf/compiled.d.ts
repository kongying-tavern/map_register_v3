...
export namespace protobuf {
  ...
  interface IMarkerExtra {
    ...
    v_2_8Island?: (protobuf.IMarkerExtra2_8_Island | null)
  }
  ...
  class MarkerExtra implements IMarkerExtra {
    ...
    /** MarkerExtra v_2_8Island. */
    public v_2_8Island?: (protobuf.IMarkerExtra2_8_Island | null)
  ...
  /** Represents a MarkerExtra2_8_Island. */
  class MarkerExtra2_8_Island implements IMarkerExtra2_8_Island {
    /**
     * Constructs a new MarkerExtra2_8_Island.
     * @param [properties] Properties to set
     */
    constructor(properties?: protobuf.IMarkerExtra2_8_Island)
     ...
     * @param [properties] Properties to set
     * @returns MarkerExtra2_8_Island instance
     */
    public static create(properties?: protobuf.IMarkerExtra2_8_Island): protobuf.MarkerExtra2_8_Island
     ...
     * @param message MarkerExtra2_8_Island message or plain object to encode
     * @param [writer] Writer to encode to
     * @returns Writer
     */
    public static encode(message: protobuf.IMarkerExtra2_8_Island, writer?: $protobuf.Writer): $protobuf.Writer
     ...
     * @returns Writer
     */
    public static encodeDelimited(message: protobuf.IMarkerExtra2_8_Island, writer?: $protobuf.Writer): $protobuf.Writer

    /**
     * Decodes a MarkerExtra2_8_Island message from the specified reader or buffer.
     * @param reader Reader or buffer to decode from
     * @param [length] Message length if known beforehand
     * @returns MarkerExtra2_8_Island
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(reader: ($protobuf.Reader | Uint8Array), length?: number): protobuf.MarkerExtra2_8_Island
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decodeDelimited(reader: ($protobuf.Reader | Uint8Array)): protobuf.MarkerExtra2_8_Island
     ...
     * @returns MarkerExtra2_8_Island
     */
    public static fromObject(object: { [k: string]: any }): protobuf.MarkerExtra2_8_Island

    /**
     * Creates a plain object from a MarkerExtra2_8_Island message. Also converts values to other types if specified.
     * @param message MarkerExtra2_8_Island
     * @param [options] Conversion options
     * @returns Plain object
     */
    public static toObject(message: protobuf.MarkerExtra2_8_Island, options?: $protobuf.IConversionOptions): { [k: string]: any }
