...
export async function createIcon(body: API.IconVo, options?: { [key: string]: unknown }) {
...
export async function updateIcon(body: API.IconVo, options?: { [key: string]: unknown }) {
...
export async function listIcon(body: API.IconSearchVo, options?: { [key: string]: unknown }) {
