...
export async function listAllMarkerLinkageBz2(options?: { [key: string]: unknown }) {
...
export async function listAllMarkerLinkageBz2MD5(options?: { [key: string]: unknown }) {
...
export async function graphAllMarkerLinkageBz2(options?: { [key: string]: unknown }) {
...
export async function graphAllMarkerLinkageBz2MD5(options?: { [key: string]: unknown }) {
