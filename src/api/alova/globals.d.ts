...
export interface MarkerRenderModelVo {
  /**
   * 乐观锁
   * ---
   */
...
export interface RListMarkerRenderModelVo {
  error?: boolean;
  errorStatus?: number;
  errorData?: object;
  message?: string;
  data?: MarkerRenderModelVo[];
  users?: Record<string, SysUserSmallVo>;
  time?: string;
}
...
declare global {
  interface Apis {
    ...
    marker: {
       ...
       * [POST] 通过ID列表查询点位渲染信息
       *
       * **path:** /api/marker/get/list_render_byid
       *
       * ---
       *
       * **RequestBody**
       ...
       * ```
       */
      listRenderMarkerById<
        Config extends Alova2MethodConfig<RListMarkerRenderModelVo> & {
          data: MarkerSearchVo;
        }
      >(
        config: Config
      ): Alova2Method<RListMarkerRenderModelVo, 'marker.listRenderMarkerById', Config>;
      /**
       * ---
       *
       * [POST] 根据各种条件筛选查询点位信息
